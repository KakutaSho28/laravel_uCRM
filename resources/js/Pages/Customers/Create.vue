                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    <div class="mx-auto lg:w-1/2 md:w-2/3">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="kana" class="text-sm leading-7 text-gray-600">カナ</label>
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="birthday"
                                                        class="text-sm leading-7 text-gray-600">生年月日</label>
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="gender"
                                                        class="text-sm leading-7 text-gray-600">性別</label>
                                            ...
                                            <div class="w-full p-2">
                                                <button
                                                    class="flex px-8 py-2 mx-auto text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">登録</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
